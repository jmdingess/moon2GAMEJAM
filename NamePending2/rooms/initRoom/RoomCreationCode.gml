...
ds_map_add(attacks[|0], "atkSprite", sMoon_atkHammer);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|2], "atkSprite", sMoon_atkKnife);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
ds_map_add(attacks[|0], "charPosition", [0, 0, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|0], "atkSprite", sSuzuki_atksword);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|2], "atkSprite", sEddie_sharpen);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
ds_map_add(attacks[|0], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 1, 1]); 
ds_map_add(attacks[|1], "power", 0.9);
ds_map_add(attacks[|0], "weight", 1);
...
ds_map_add(global.enemies[10], "hit", sDoar_Atk);
...
ds_map_add(global.enemies[12], "hurt", sOldMoon_hit);
