...
ds_map_add(attacks[|0], "atkSprite", sPlaceholderChar);
...
ds_map_add(global.characters[0], "hit", sPlaceholderChar);
...
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
ds_map_add(attacks[|0], "sprite", sMoon_buttonBan);
ds_map_add(attacks[|0], "type", targetting.TARGET);
...
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
ds_map_add(attacks[|1], "sprite", sMoon_buttonSMD);
ds_map_add(attacks[|1], "type", targetting.TARGET);
...
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
ds_map_add(attacks[|2], "sprite", sMoon_buttonSha);
ds_map_add(attacks[|2], "type", targetting.TARGET);
...
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
ds_map_add(attacks[|3], "sprite", sMoon_buttonBlap);
...
ds_map_add(attacks[|3], "atkSprite", sMoon_atkGun);
attacks[|4] = ds_map_create();
ds_map_add(attacks[|4], "id", 4);
ds_map_add(attacks[|4], "sprite", sMoon_buttonVariety);
...
ds_map_add(attacks[|0], "atkSprite", sTesla_atkspeed);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|2], "atkSprite", sTesla_hit);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
ds_map_add(attacks[|4], "atkSprite", sTesla_atklaser);
...
ds_map_add(attacks[|0], "charPosition", [0, 0, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|0], "atkSprite", sSuzuki_atkgun);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|1], "targetPosition", [0, 1, 1, 1]);
ds_map_add(attacks[|1], "atkSprite", sSuzuki_atkgun);
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
...
ds_map_add(attacks[|2], "atkSprite", sSuzuki_atkpillow);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
ds_map_add(attacks[|1], "sprite", sPurpleLady_buttonToxic);
...
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
ds_map_add(attacks[|2], "sprite", sPurpleLady_buttonCheer);
ds_map_add(attacks[|2], "type", targetting.TARGET);
...
ds_map_add(attacks[|3], "targetAllyPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|3], "atkSprite", sPurpleLady_cheer);
attacks[|4] = ds_map_create();
ds_map_add(attacks[|4], "id", 4);
ds_map_add(attacks[|4], "sprite", sPurpleLady_buttonAngry);
ds_map_add(attacks[|4], "type", targetting.TARGETALL);
...
ds_map_add(global.characters[4], "hit", sPurpleLady_hit);
...
ds_map_add(attacks[|0], "charPosition", [0, 0, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|0], "atkSprite", sAniki_atkwhip);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|1], "desc", "Team Strength buff");
ds_map_add(attacks[|1], "charPosition", [0, 0, 1, 1]);
ds_map_add(attacks[|1], "targetAllyPosition", [1, 1, 1, 1]);
...
ds_map_add(attacks[|2], "atkSprite", sAniki_atkwhip);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
ds_map_add(attacks[|4], "charPosition", [0, 0, 1, 1]);
ds_map_add(attacks[|4], "targetPosition", [0, 1, 1, 0]);
ds_map_add(attacks[|4], "atkSprite", sAniki_hit);
ds_map_add(global.characters[5], "attacks", attacks);
ds_map_add(global.characters[5], "stats", [35, 0, 0, 9, 3, 4, 8, 2, 4]);
ds_map_add(global.characters[5], "hit", sAniki_hit);
...
ds_map_add(attacks[|0], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|0], "atkSprite", sEddie_Atkscratch);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|1], "charPosition", [0, 1, 1, 1]);
ds_map_add(attacks[|1], "targetAllyPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|1], "atkSprite", sEddie_lick);
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
...
ds_map_add(attacks[|2], "atkSprite", sEddie_lick);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
ds_map_add(attacks[|0], "sprite", sBarwick_buttontryhard);
ds_map_add(attacks[|0], "type", targetting.TARGETSELF);
ds_map_add(attacks[|0], "displayName", "Try Hard");
ds_map_add(attacks[|0], "desc", "Toggle ability increases dexterity and strength but also lowers evasion.");
ds_map_add(attacks[|0], "charPosition", [0, 1, 1, 1]);
ds_map_add(attacks[|0], "atkSprite", sBarwick_dab);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
ds_map_add(attacks[|1], "sprite", sBarwick_buttonsandbag);
...
ds_map_add(attacks[|1], "atkSprite", sBarwick_dab);
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
ds_map_add(attacks[|2], "sprite", sBarwick_button100);
ds_map_add(attacks[|2], "type", targetting.TARGET);
ds_map_add(attacks[|2], "displayName", "100 to Zero");
ds_map_add(attacks[|2], "desc", "Target 1 enemy ATK ; skips next turn");
ds_map_add(attacks[|2], "charPosition", [0, 1, 1, 1]);
ds_map_add(attacks[|2], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|2], "atkSprite", sBarwick_atk);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
ds_map_add(attacks[|3], "sprite", sBarwick_buttonrush);
ds_map_add(attacks[|3], "type", targetting.TARGET);
ds_map_add(attacks[|3], "displayName", "Rushdown");
ds_map_add(attacks[|3], "desc", "Attack enemy, move forward two spaces");
ds_map_add(attacks[|3], "charPosition", [1, 1, 1, 0]);
ds_map_add(attacks[|3], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|3], "atkSprite", sBarwick_spin);
attacks[|4] = ds_map_create();
ds_map_add(attacks[|4], "id", 4);
ds_map_add(attacks[|4], "sprite", sBarwick_buttonspintop);
ds_map_add(attacks[|4], "type", targetting.TARGET);
...
ds_map_add(attacks[|1], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|1], "power", 1.5);
...
ds_map_add(global.enemies[1], "hit", sMoon2S_hit);
...
ds_map_add(attacks[|0], "desc", "Asks the streamer what OW/TOL stands for, DEX/INT Down");
ds_map_add(attacks[|0], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 1, 1]); 
ds_map_add(attacks[|0], "weight", 1);
...
ds_map_add(global.enemies[2], "stats", [14, 0, 0, 1, 2, 7, 7, 7, 6]);
ds_map_add(global.enemies[2], "hit", sPrimePleb_hit);
...
//No hit since hes just gonna blow up anyway
...
ds_map_add(attacks[|1], "targetAllyPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|1], "weight", 1);
ds_map_add(attacks[|1], "atkSprite", sMoon2N_atk);
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 1);
ds_map_add(attacks[|2], "sprite", sMoon2N_atk);
ds_map_add(attacks[|2], "type", targetting.TARGETALL);
ds_map_add(attacks[|2], "displayName", "Perfectly Balanced");
ds_map_add(attacks[|2], "desc", "Changes everyones health to 50%");
ds_map_add(attacks[|2], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "targetPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "targetAllyPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "weight", 1);
ds_map_add(attacks[|2], "atkSprite", sMoon2N_infinity);
ds_map_add(global.enemies[4], "attacks", attacks);
ds_map_add(global.enemies[4], "stats", [18, 0, 0, 4, 4, 10, 4, 6, 2]);
ds_map_add(global.enemies[4], "hit", sMoon2N_hit);
...
ds_map_add(attacks[|1], "desc", "Attack target, chance to cause stun");
ds_map_add(attacks[|1], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|1], "targetPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|1], "weight", 2);
...
ds_map_add(attacks[|2], "desc", "Attack, lower ATK and ACC");
ds_map_add(attacks[|2], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "targetPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "weight", 1);
ds_map_add(attacks[|2], "atkSprite", sTrog_atk);
ds_map_add(global.enemies[6], "attacks", attacks);
ds_map_add(global.enemies[6], "stats", [17, 0, 0, 5, 6, 5, 3, 8, 3]);
ds_map_add(global.enemies[6], "hit", sTrog_hit);
...
ds_map_add(global.enemies[7], "stats", [20, 0, 0, 10, 6, 4, 4, 2, 4]);
ds_map_add(global.enemies[7], "hit", sMoon2VeryA_hit);
...
ds_map_add(attacks[|0], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 0, 0]); 
ds_map_add(attacks[|0], "power", 2);
ds_map_add(attacks[|0], "weight", 1);
ds_map_add(attacks[|0], "atkSprite", sPoopSnail_atk);
ds_map_add(global.enemies[8], "attacks", attacks);
ds_map_add(global.enemies[8], "stats", [17, 0, 0, 5, 5, 9, 4, 8, 5]);
ds_map_add(global.enemies[8], "hit", sPoopSnail_hit);
...
ds_map_add(attacks[|0], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 1, 1]); 
ds_map_add(attacks[|0], "power", 0.9);
ds_map_add(attacks[|0], "weight", 1);
ds_map_add(attacks[|0], "atkSprite", sRabbit_Atk);
ds_map_add(global.enemies[9], "attacks", attacks);
ds_map_add(global.enemies[9], "stats", [12, 0, 0, 1, 6, 4, 6, 7, 6]);
ds_map_add(global.enemies[9], "hit", sRabbit_hit);
...
ds_map_add(attacks[|0], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|0], "targetPosition", [1, 1, 1, 1]); 
ds_map_add(attacks[|0], "power", 1.2);
ds_map_add(attacks[|0], "weight", 1);
ds_map_add(attacks[|0], "atkSprite", sDoar_Atk);
ds_map_add(global.enemies[10], "attacks", attacks);
ds_map_add(global.enemies[10], "stats", [12, 0, 0, 1, 6, 4, 6, 7, 6]);
ds_map_add(global.enemies[10], "hit", sDoar_hit);
...
ds_map_add(global.enemies[11], "hit", sFox_hit);
...
ds_map_add(attacks[|0], "atkSprite", sEsports_puppet);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|2], "targetPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "weight", 1);
ds_map_add(attacks[|2], "atkSprite", sEsports_puppet);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
ds_map_add(attacks[|3], "targetPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|1], "power", 0.8);
ds_map_add(attacks[|3], "weight", 2);
...
ds_map_add(global.enemies[12], "hit", sEsports_hit);
...
ds_map_add(attacks[|1], "power", 1.2);
ds_map_add(attacks[|1], "weight", 1);
...
ds_map_add(attacks[|2], "charPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|2], "targetPosition", [1, 1, 0, 0]);
ds_map_add(attacks[|1], "power", 1.1);
ds_map_add(attacks[|2], "weight", 1);
ds_map_add(attacks[|2], "atkSprite", sRicardo_Hit);
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
...
ds_map_add(global.enemies[14], "hurt", sOldMoon_hit);
...
ds_map_add(attacks[|0], "targetPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|0], "weight", 1);
ds_map_add(attacks[|0], "atkSprite", sOldMoon2_howl);
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
...
ds_map_add(attacks[|1], "targetAllyPosition", [1, 1, 1, 1]);
ds_map_add(attacks[|1], "weight", 1);
ds_map_add(attacks[|1], "atkSprite", sOldMoon2_howl);
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
...
ds_map_add(global.enemies[15], "hurt", sOldMoon2_hit);
