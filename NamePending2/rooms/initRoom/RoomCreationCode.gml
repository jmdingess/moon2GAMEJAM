...
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
ds_map_add(attacks[|0], "sprite", sSuzuki_atk);
ds_map_add(attacks[|0], "type", targetting.TARGET);
...
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
ds_map_add(attacks[|1], "sprite", sSuzuki_atk);
ds_map_add(attacks[|1], "type", targetting.TARGET);
...
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
ds_map_add(attacks[|2], "sprite", sSuzuki_atk);
ds_map_add(attacks[|2], "type", targetting.TARGET);
...
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
ds_map_add(attacks[|3], "sprite", sSuzuki_atk);
...
attacks[|4] = ds_map_create();
ds_map_add(attacks[|4], "id", 4);
ds_map_add(attacks[|4], "sprite", sSuzuki_atk);
ds_map_add(attacks[|4], "type", targetting.TARGETALL);
...
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
ds_map_add(attacks[|0], "sprite", sPurpleLady_atk);
ds_map_add(attacks[|0], "type", targetting.TARGET);
...
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
ds_map_add(attacks[|0], "sprite", sAniki_atk);
ds_map_add(attacks[|0], "type", targetting.TARGET);
...
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
ds_map_add(attacks[|1], "sprite", sAniki_atk);
...
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
ds_map_add(attacks[|2], "sprite", sAniki_atk);
ds_map_add(attacks[|2], "type", targetting.TARGET);
...
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
ds_map_add(attacks[|3], "sprite", sAniki_atk);
ds_map_add(attacks[|3], "type", targetting.TARGET);
...
attacks[|4] = ds_map_create();
ds_map_add(attacks[|4], "id", 4);
ds_map_add(attacks[|4], "sprite", sAniki_atk);
...
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
ds_map_add(attacks[|0], "sprite", sEddie_Atk);
ds_map_add(attacks[|0], "type", targetting.TARGET);
...
attacks[|1] = ds_map_create();
ds_map_add(attacks[|1], "id", 1);
ds_map_add(attacks[|1], "sprite", sEddie_Atk);
...
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
ds_map_add(attacks[|2], "sprite", sEddie_Atk);
...
attacks[|3] = ds_map_create();
ds_map_add(attacks[|3], "id", 3);
ds_map_add(attacks[|3], "sprite", sEddie_Atk);
ds_map_add(attacks[|3], "type", targetting.TARGET);
...
attacks[|4] = ds_map_create();
ds_map_add(attacks[|4], "id", 4);
ds_map_add(attacks[|4], "sprite", sEddie_Atk);
...
ds_map_add(attacks[|1], "desc", "Riposete and Acc buff");
ds_map_add(attacks[|1], "charPosition", [0, 1, 1, 1]);
ds_map_add(attacks[|1], "targetPosition", [0, 0, 0, 0]);
attacks[|2] = ds_map_create();
ds_map_add(attacks[|2], "id", 2);
...
ds_map_add(global.enemies[8], "displayName", "Corporation");
ds_map_add(global.enemies[8], "sprite", sEsports);
attacks = ds_list_create();
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
...
//We should make this attack always happen first, and not happen until each other option has been used?
...
ds_map_add(attacks[|2], "desc", "Target skips their next turn");
...
ds_map_add(global.enemies[9], "displayName", "Ricardo Milos");
ds_map_add(global.enemies[9], "sprite", sRicardo);
attacks = ds_list_create();
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
...
ds_map_add(global.enemies[10], "displayName", "The Old Moon");
ds_map_add(global.enemies[10], "sprite", sOldMoon);
attacks = ds_list_create();
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
...
ds_map_add(global.enemies[11], "type", "Boss");
ds_map_add(global.enemies[11], "displayName", "The true pit");
ds_map_add(global.enemies[11], "sprite", sOldMoon2);
attacks = ds_list_create();
attacks[|0] = ds_map_create();
ds_map_add(attacks[|0], "id", 0);
...
ds_map_add(global.enemies[11], "stats", [0, 0, 0, 0, 0, 0, 0, 0, 0]);
